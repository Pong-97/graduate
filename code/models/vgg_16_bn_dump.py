...
class VGG(nn.Module):
    ...
    def forward(self, x):
        ...
        threshold = sum(channel_rank)/data.shape[1]
...
def test(model, test_loader, optimizer=None, file_path=None):
    ...
    for data, target in test_loader:
        ...
        # 导出idx
        pdb.set_trace()
        idx_path = "/home2/pengyifan/pyf/hypergraph_cluster/log/graduate/vgg/mutemin_290_idx.json"
        index_dict = {}
...
if __name__ == '__main__':
    file_path = "/home2/pengyifan/pyf/hypergraph_cluster/log/graduate/vgg/1.json"
    res_dict = {}
